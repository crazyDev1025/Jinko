...
export var ScrollTrigger = /*#__PURE__*/ (function () {
  ...
  _proto.init = function init(vars, animation) {
    ...
    if (animation) {
      ...
      scrubTween &&
        scrubTween.resetTo &&
        scrubTween.resetTo("totalProgress", 0); // otherwise the initial scrub progress value would start at 0.001 which normally is no big deal, but for containerAnimation it can be noticeable since the range is so tiny.
